                ...
                <tr key={idx} className="border-b border-slate-700/50 hover:bg-slate-700/20 transition-colors">
                  ...
                  <td className="py-2 text-right">
                    <span className={`text-xs px-1.5 py-0.5 rounded ${
                      ...
                      obs.exit_reason === 'hard_stop' ? 'bg-red-900/40 text-red-400' :
                      'bg-slate-700 text-slate-400'
                    }`}>
                      {obs.exit_reason === 'target'    ? 'target'    :
                       obs.exit_reason === 'open'      ? 'open'      :
                       obs.exit_reason === 'hard_stop' ? 'hard stop' : 'time stop'}
                    </span>
                  </td>
                </tr>
              )
